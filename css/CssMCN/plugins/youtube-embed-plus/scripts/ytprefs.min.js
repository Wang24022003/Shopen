    ...
    "undefined" === typeof b._EPADashboard_ && (b._EPADashboard_ = {
        ...
        apiInit: function() {
            if ("undefined" !== typeof b.YT) {
                ...
                for (var a = document.querySelectorAll(_EPYT_.evselector), c = 0; c < a.length; c++) a[c].hasAttribute("id") || (a[c].id = "_dytid_" + Math.round(8999 * Math.random() + 1E3)), b._EPADashboard_.setupevents(a[c].id)
            }
        },
        log: function(a) {
            try {
        ...
        loadYTAPI: function() {
            if ("undefined" === typeof b.YT) {
                ...
                if (b._EPYT_.pageLoaded) b._EPADashboard_.apiInit(), b._EPADashboard_.log("YT API available");
        ...
        resolveFacadeQuality: function(a, c) {
            ...
            if (c || 200 > a.naturalHeight)
                if (c = d(a).attr("src")) d(a).attr("src", c.replace("maxresdefault",
                    "hqdefault")), d(a).off("load.epyt");
        ...
        pageReady: function() {
            b._EPYT_.not_live_on_channel &&
                "never" !== b._EPYT_.ytapi_load && d(".epyt-live-channel").each(function() {
                    var a = d(this);
                    a.data("eypt-fallback") || (a.data("eypt-fallback", !0), a.css("opacity", 0), setTimeout(function() {
                        a.css("opacity", 1)
                    }, 4E3))
                });
            d(".epyt-gallery").each(function() {
                ...
                if (!a.data("epytevents") || !d("body").hasClass("block-editor-page")) {
                    ...
                    "undefined" !== typeof e ? (e = e.replace(g, "GALLERYVIDEOID"), a.data("ep-gallerysrc", e)) : c.hasClass("__youtube_prefs_gdpr__") && a.data("ep-gallerysrc", "");
